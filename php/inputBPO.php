      ...
      <div class="x_content">
        ...
        <form class="form-horizontal form-label-left" method="post" action="">
          ...
          <div class="form-group">
            <label for="judul" class="control-label col-md-3 col-sm-3 col-xs-12">Nama Project</label>
            <div class="col-md-9 col-sm-9 col-xs-12">
              <input class="form-control" id="judul" type="text" value="<?=$row['nama_project']?>" readonly='readonly'>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
              ...
              <button type="submit" name="addDataBPO" class="btn btn-success">Submit</button>
            </div>
          </div>
