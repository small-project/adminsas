...
<div class="col-md-6 col-lg-offset-3">
   <div class="well">
      ...
      <hr>
      <p>Silahkan untuk membuat pengajuan request <a href=""><span class="label label-danger"><strong>LIST LOKER</strong></span></a> untuk posisi <span class="label label-danger"><?php
         echo $row['nama_pekerjaan'];
         ?></span>.</p>
   </div>
</div>
